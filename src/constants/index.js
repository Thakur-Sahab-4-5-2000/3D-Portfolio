...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Diagnosed and resolved critical bugs in the application, enhancing overall stability and user satisfaction.",
      "Collaborated with the QA team to identify and fix performance bottlenecks, resulting in a 25% improvement in application speed.",
      "Redesigned and implemented responsive UI components, leading to a 30% increase in mobile user engagement.",
    ],
  },
];
